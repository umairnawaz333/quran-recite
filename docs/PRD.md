> This is the original product requirements document for the full product
> vision. Phase 1 (this repository, as built) implements a subset of it —
> see the main [`README.md`](../README.md) for what is actually shipped.
